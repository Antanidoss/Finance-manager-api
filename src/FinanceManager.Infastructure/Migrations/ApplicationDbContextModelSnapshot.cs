...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceManager.Domain.Entities.AppUser", b =>
                {
            ...
            modelBuilder.Entity("FinanceManager.Domain.Entities.DailyReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FinanceManager.Domain.Entities.Report", b =>
                {
                    ...
                    b.Property<string>("DescriptionsOfExpenses")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FinanceManager.Domain.Entities.DailyReport", b =>
                {
                    b.HasOne("FinanceManager.Domain.Entities.AppUser", "AppUser")
            ...
            modelBuilder.Entity("FinanceManager.Domain.Entities.Report", b =>
                {
                    b.HasOne("FinanceManager.Domain.Entities.DailyReport", "DailyReport")
                        .WithMany("Reports")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FinanceManager.Domain.Entities.AppUser", null)
                        .WithMany()
